...
[Live Trading Radar](https://josslignio.github.io/weekly-trading-radar-dashboard/latest/report.html)

</div>

I combine 10+ years in growth, business development and ecosystem building with hands-on AI automation.
...
- **Outcome-first delivery** — start from the visible product result and plan backward.
- **Evidence before assumptions** — verify the real environment, current state and external acceptance.
- **Low-context execution** — use compact project state instead of repeatedly loading full histories.
- **Safe autonomy** — bounded retries, explicit approval boundaries and reversible learning.
- **Growth impact** — connect systems to acquisition, partnerships, revenue and operating leverage.

## Selected impact

- **Zealy:** helped scale the platform to 2M+ MAU and 5,000+ companies.
- **P1 Studio:** supported 60+ clients including Web3, fintech and digital teams.
- **SECR3T:** co-led a digital-art launch generating $1M+ in sales and selling out in nine minutes.
- **International execution:** French native; fluent English; professional Portuguese and Spanish.

## Current focus

AI automation · GTM systems · Growth operations · Business development · Partnerships · Data pipelines · Web3

## Open to

Senior roles and collaborations across **Growth, Business Development, Partnerships, AI Operations and GTM Automation**, with a focus on remote Europe.

---

<sub>Production repositories and sensitive operational data remain private. Public repositories document architecture, validated outputs and sanitized examples.</sub>
